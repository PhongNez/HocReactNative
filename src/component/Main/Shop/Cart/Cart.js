...
import { Button, Text, TouchableOpacity, View, FlatList, Image } from 'react-native'
...
export default class Cart extends Component {
    constructor(props) {
        ...
        global.setArrCart = (listCart) => this.setState({ listCart: listCart },
    ...
    addCart = async () => {
        ...
        let response = await axios.post('http://192.168.103.6:8081/api/v1/product/2');
    ...
    deleteCart = async (id_product) => {
        ...
        //let response = await handleGetAllUserShop()
        // let response = await axios.get('http://192.168.103.6:8081/api/v1/admin/account')
        let response = await axios.delete(`http://192.168.103.6:8081/api/v1/product/${id_product}`);
            ...
            <View style={{ backgroundColor: "green", flex: 1, alignItems: "center" }}>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) =>
                        ...
                        <View style={{
                            borderWidth: 1,
                            width: 300, shadowColor: '#2E272B',
                            shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.2,
                            marginBottom: 10,
                            padding: 10,
                            backgroundColor: '#95819c', flexDirection: "row"
                        }}>

                            <View>
                                <Image source={{ uri: `http://192.168.103.6:8081/${item.images}` }} style={{ height: 60, width: 60, alignItems: "center" }}></Image>
                            </View>
