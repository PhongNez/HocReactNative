...
export default class Search extends Component {
    ...
    onSearch = async () => {
        //console.log('Phong');
        let data = { name: 1 }
        let res = await axios.post('http://192.168.103.6:8081/api/v1/search', { name: this.state.textSearch },
    ...
    render() {
        return (
            <View style={{ backgroundColor: "brown" }}>
                <TextInput style={{ height: windowHeight / 20, backgroundColor: '#ffffff', }}
